...
public class CardView2 extends ImageView implements AnimationListener, View.OnClickListener {
    private int imageNo; // カード番号
    private boolean state; // 選択フラグ
    ...
    public CardView2(Context context, Drawable img1, Drawable img2, int imageNo) {
        super(context);
    ...
    public void onClick(View v) {
      Log.d("onClick", "onClick--->" + getImageNo());
